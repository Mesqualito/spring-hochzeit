package rocks.gebsattel.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("weddingApp");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("weddingApp");
        ...
        config.getMapConfigs().put("rocks.gebsattel.domain.*", initializeDomainMapConfig(jHipsterProperties));
